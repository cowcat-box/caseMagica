const sidebar = {
  ...
  'sidebar.confirmDeleteOne': 'Delete {{path}}. CaseMagica saves a version first, so you can restore it from version history.',
  'sidebar.confirmDeleteMany': 'Delete the selected {{count}} item(s). CaseMagica saves a version first, so you can restore them from version history.',
