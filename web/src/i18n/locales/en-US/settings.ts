const settings = {
  ...
  'settings.access.restartHint': 'After enabling this and restarting CaseMagica, CaseMagica listens on the LAN address. Other devices on the same local network can open CaseMagica with the startup access URL and sign in on the page with this username and password. Localhost access does not require login.',
  ...
  'settings.updates.applyingRestart': 'CaseMagica is restarting and applying the update. This page will refresh when the new version is ready.',
  'settings.updates.install': 'Install Update',
  'settings.updates.installedRestart': 'Update installed. Restart CaseMagica to use the new version.',
  ...
  'settings.updates.stagedRestart': 'Update staged. Restart and install to exit CaseMagica, replace files, and launch the new version automatically.',
  'settings.updates.updateAvailableTitle': 'New version available',
  'settings.updates.upToDateTitle': 'CaseMagica is up to date',
  ...
  'settings.debug.llmInputLogHelp': 'Available only in development mode. When enabled, CaseMagica asynchronously writes the full model-visible context, tool schemas, and non-secret model parameters to log/llm-inputs.jsonl. The file can be large and may contain user text; use it only for diagnostics.',
  ...
  'settings.paths.denovaDir': 'CaseMagica Data Directory',
