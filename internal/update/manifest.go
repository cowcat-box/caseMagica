...
// ApplyManifest is the updater contract written by CaseMagica and consumed by
// casemagica-updater. Paths are absolute so the updater can run after CaseMagica exits.
